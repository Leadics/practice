                ...
                <ul class="nav pull-right top-menu">
                    ...
                    <li id="task_notificatoin_bar" class="dropdown">
                        ...
                        <ul class="dropdown-menu extended tasks-bar">
                            ...
                            <li class="external">
                                <a href="<?php echo ABSOLUTE_URL;?>/ang/#">See All Tasks</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu extended logout">
                            ...
                            <li>
                                <a href="<?php echo ABSOLUTE_URL;?>/ang/#"><i class="icon_clock_alt"></i> Timeline</a>
                            </li>
                            <li>
                                <a href="<?php echo ABSOLUTE_URL;?>/ang/#"><i class="icon_chat_alt"></i> Chats</a>
                            </li>
                            <li>
                                <a href="<?php echo ABSOLUTE_URL;?>/ang/login.html"><i class="icon_key_alt"></i> Log Out</a>
                            </li>
                            <li>
                                <a href="<?php echo ABSOLUTE_URL;?>/ang/documentation.html"><i class="icon_key_alt"></i> Documentation</a>
                            </li>
                            <li>
                                <a href="<?php echo ABSOLUTE_URL;?>/ang/documentation.html"><i class="icon_key_alt"></i> Documentation</a>
                            </li>
          ...
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu">                
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">                          
                          <li><a class="" href="<?php echo ABSOLUTE_URL;?>/ang/profile.html">Profile</a></li>
