 <header id="header">
    <div class="container">
      ...
      <div id="logo" class="pull-left">
        <a href="<?php echo ABSOLUTE_URL;?>/pages/home#hero"><img src="<?php echo ABSOLUTE_URL;?>/Imperial/img/logo.png" alt="" title="" /></img></a>
        <!-- Uncomment below if you prefer to use a text image -->
        <!--<h1><a href="<?php echo ABSOLUTE_URL;?>/pages/home#hero">Header 1</a></h1>-->
      </div>
